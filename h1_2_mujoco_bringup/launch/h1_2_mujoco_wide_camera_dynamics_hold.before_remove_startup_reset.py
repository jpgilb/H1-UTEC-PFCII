...
def generate_launch_description():
        ...
        actions=[
            Node(
                ...
                parameters=[{
                    ...
                    # Fase 1D: stronger hold around reset/startup pose
                    "kp_shoulder_pitch_roll": 80.0,
                    "kd_shoulder_pitch_roll": 10.0,
                    "kp_shoulder_yaw": 30.0,
                    "kd_shoulder_yaw": 4.0,
                    "kp_elbow": 120.0,
                    "kd_elbow": 14.0,
                    "kp_wrist": 40.0,
    ...
    # Startup reset manager node: resets the world and recaptures q_hold after initial hold is ready
    startup_reset_node = TimerAction(
        period=8.5,
        actions=[
            Node(
                package="h1_2_mujoco_bringup",
                executable="mujoco_pause_until_hold_ready.py",
                name="mujoco_startup_reset_after_hold",
                arguments=["--reset-after-hold-ready"],
                output="screen",
            )
        ],
    )

...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            ...
            default_value='true',
            description='Habilitar diagnóstico detallado de colisiones mediante check_state_validity al fallar el IK'
        ),
        DeclareLaunchArgument(
    ...
    static_tf_pub_node = Node(
        ...
        arguments=['0.54', '0.30', '0.08', '0', '0', '0', '1', 'pelvis', 'objeto_cubo']
    )

...
def generate_launch_description():
    ...
    # PURE VISION MODE:
    # No se publica TF estático de objeto_cubo.
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            ...
            description='Frame ArUco usado como referencia de destino de mesa'
        ),
        DeclareLaunchArgument(
            'table_target_offset_x',
            default_value='0.042',
            description='Offset X desde ArUco al centro objetivo de mesa'
        ),
        DeclareLaunchArgument(
            'table_target_offset_y',
            default_value='0.118',
            description='Offset Y desde ArUco al centro objetivo de mesa'
        ),
        DeclareLaunchArgument(
            'table_target_offset_z',
            default_value='-0.006',
            description='Offset Z desde ArUco al centro objetivo de mesa'
        ),
        DeclareLaunchArgument(
            'table_target_offset_mode',
            default_value='base',
            description='Modo del offset ArUco: base o marker_yaw'
        ),
        DeclareLaunchArgument(
            'aruco_z_is_table_surface',
            default_value='true',
            description='Interpretar Z del ArUco como superficie de mesa'
        ),
        DeclareLaunchArgument(
            'validate_aruco_table_target_ik',
            default_value='false',
            description='Validar IK del destino ArUco antes de ejecutar'
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value='0.006',
            description='Tolerancia direccional Z mínima antes de Fase 4 shelf [m]'
        ),
        ...
        DeclareLaunchArgument(
            ...
            default_value='0.02',
            description='Tolerancia articular para confirmar apertura de mano'
        ),
        DeclareLaunchArgument(
            'release_settle_time',
            default_value='9',
        ...
        DeclareLaunchArgument(
            'use_registered_release_pose_for_next_stage',
            default_value='true',
            description='Usar pose real registrada sobre mesa para la segunda etapa'
        ),
        DeclareLaunchArgument(
            'publish_object_state_only_after_initial_tf',
            default_value='true',
            description='No publicar estado visual hacia MuJoCo hasta tener TF inicial válido'
        ),
        DeclareLaunchArgument(
            'clamp_table_release_z_to_support',
            default_value='true',
            description='Corregir solo Z si el objeto queda físicamente debajo del plano de apoyo de mesa'
        ),
        DeclareLaunchArgument(
            'table_release_z_clamp_tolerance',
            default_value='0.002',
            description='Tolerancia vertical antes de aplicar clamp de apoyo en mesa'
        ),
        DeclareLaunchArgument(
            'table_release_z_clearance_margin',
            default_value='0.0',
            description='Margen adicional de Z al aplicar clamp físico sobre mesa'
        ),
        DeclareLaunchArgument(
            'phase12_disable_release_acm_before_retreat',
            default_value='true',
            description='Deshabilitar ACM mano-objeto antes de Fase 12 para evitar atravesar el cubo'
        ),
        DeclareLaunchArgument(
            'force_table_phase12_retreat_before_home',
            default_value='true',
        ...
        DeclareLaunchArgument(
            'defer_shelf_place_yaw_until_preinsert',
            default_value='true',
            description='Diferir yaw final de place en shelf hasta preinsert'
        ),
        DeclareLaunchArgument(
            'defer_phase8_orientation_until_preplace',
            default_value='true',
            description='Diferir orientación final de place hasta preplace cuando yaw significativo'
        ),
        DeclareLaunchArgument(
            'phase8_orientation_defer_threshold_deg',
            default_value='5.0',
            description='Umbral de yaw para activar defer de orientación en Fase 8'
        ),
        DeclareLaunchArgument(
            'phase8_direct_preplace_first_enabled',
            default_value='true',
        ...
        DeclareLaunchArgument(
            'ompl_pipeline_id',
            default_value='ompl',
            description='Pipeline de planificación MoveIt a usar'
        ),
        DeclareLaunchArgument(
            'ompl_planner_id',
            default_value='RRTConnectkConfigDefault',
            description='Planner OMPL explícito. Vacío = planner default de MoveIt'
        ),
        ...
        DeclareLaunchArgument(
            ...
            default_value='15.0',
            description='Tiempo máximo de planificación OMPL [s]'
        ),
        DeclareLaunchArgument(
            'ompl_max_velocity_scaling_factor',
            default_value='0.10',
            description='Escalado global de velocidad OMPL'
        ),
        DeclareLaunchArgument(
            'ompl_max_acceleration_scaling_factor',
            default_value='0.10',
            description='Escalado global de aceleración OMPL'
        ),
        DeclareLaunchArgument(
            'ompl_joint_goal_tolerance',
            default_value='0.015',
            description='Tolerancia articular de objetivo OMPL'
        ),
        DeclareLaunchArgument(
            'near_object_motion_slowdown_enabled',
            default_value='true',
            description='Activar perfil dinámico conservador cerca del objeto'
        ),
        DeclareLaunchArgument(
            'phase2_near_object_velocity_scaling',
            default_value='0.055',
            description='Velocity scaling local Fase 2'
        ),
        DeclareLaunchArgument(
            'phase2_near_object_acceleration_scaling',
            default_value='0.040',
            description='Acceleration scaling local Fase 2'
        ),
        DeclareLaunchArgument(
            'phase4_near_object_velocity_scaling',
            default_value='0.035',
            description='Velocity scaling local Fase 4'
        ),
        DeclareLaunchArgument(
            'phase4_near_object_acceleration_scaling',
            default_value='0.025',
            description='Acceleration scaling local Fase 4'
        ),
        DeclareLaunchArgument(
            'phase7_near_object_velocity_scaling',
            default_value='0.055',
            description='Velocity scaling local Fase 7'
        ),
        DeclareLaunchArgument(
            'phase7_near_object_acceleration_scaling',
            default_value='0.040',
            description='Acceleration scaling local Fase 7'
        ),
        DeclareLaunchArgument(
            'phase9_near_object_velocity_scaling',
            default_value='0.045',
            description='Velocity scaling local Fase 9'
        ),
        DeclareLaunchArgument(
            'phase9_near_object_acceleration_scaling',
            default_value='0.030',
            description='Acceleration scaling local Fase 9'
        ),
        DeclareLaunchArgument(
            'cartesian_near_object_time_scale',
            default_value='2.0',
    ...
    mover_brazo_single_node = Node(
        ...
        parameters=[{
            ...
            'vision_table_sample_interval': 0.30,
            'vision_table_max_attempts': 2,
            'vision_table_stability_max_std_xyz': 0.006,
            'vision_table_stability_max_range_xyz': 0.015,
            'vision_table_roi_xy': 0.080,
            'vision_table_roi_z_below': 0.030,
            'vision_table_roi_z_above': 0.050,
            ...
            'table_release_z_clearance_margin': LaunchConfiguration('table_release_z_clearance_margin'),
            'phase12_disable_release_acm_before_retreat': LaunchConfiguration('phase12_disable_release_acm_before_retreat'),
            'force_table_phase12_retreat_before_home': LaunchConfiguration('force_table_phase12_retreat_before_home'),
            ...
            'defer_shelf_place_yaw_until_preinsert': LaunchConfiguration('defer_shelf_place_yaw_until_preinsert'),
            'defer_phase8_orientation_until_preplace': LaunchConfiguration('defer_phase8_orientation_until_preplace'),
            'phase8_orientation_defer_threshold_deg': LaunchConfiguration('phase8_orientation_defer_threshold_deg'),
            'phase8_direct_preplace_first_enabled': LaunchConfiguration('phase8_direct_preplace_first_enabled'),
            'ompl_pipeline_id': LaunchConfiguration('ompl_pipeline_id'),
            'ompl_planner_id': LaunchConfiguration('ompl_planner_id'),
            ...
            'near_object_motion_slowdown_enabled': LaunchConfiguration('near_object_motion_slowdown_enabled'),
            'phase2_near_object_velocity_scaling': LaunchConfiguration('phase2_near_object_velocity_scaling'),
            'phase2_near_object_acceleration_scaling': LaunchConfiguration('phase2_near_object_acceleration_scaling'),
            'phase4_near_object_velocity_scaling': LaunchConfiguration('phase4_near_object_velocity_scaling'),
            'phase4_near_object_acceleration_scaling': LaunchConfiguration('phase4_near_object_acceleration_scaling'),
            'phase7_near_object_velocity_scaling': LaunchConfiguration('phase7_near_object_velocity_scaling'),
            'phase7_near_object_acceleration_scaling': LaunchConfiguration('phase7_near_object_acceleration_scaling'),
            'phase9_near_object_velocity_scaling': LaunchConfiguration('phase9_near_object_velocity_scaling'),
            'phase9_near_object_acceleration_scaling': LaunchConfiguration('phase9_near_object_acceleration_scaling'),
            'cartesian_near_object_time_scale': LaunchConfiguration('cartesian_near_object_time_scale'),
